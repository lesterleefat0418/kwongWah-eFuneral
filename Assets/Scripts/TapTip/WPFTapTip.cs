...
namespace WPFTabTip
{
    public static class TabTip
    {
        ...
        public static void SetTabTipWindowSize(int width, int height)
        {
            IntPtr tabTipWindowHandle = GetTabTipWindowHandle();
            SetWindowPos(tabTipWindowHandle, IntPtr.Zero, 0, 0, width, height, SWP_SHOWWINDOW);
        }

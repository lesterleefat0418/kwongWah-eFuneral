...
$folderName = date("Ymd");
$directory = __DIR__."/uploads/results_qr/".$folderName;
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['file']) && $_FILES['file']['error'] === UPLOAD_ERR_OK) {
        ...
        if (move_uploaded_file($_FILES['file']['tmp_name'], $destination)) {
            ...
            $url = 'http://' . $serverIp . substr($_SERVER['PHP_SELF'], 0, strrpos($_SERVER['PHP_SELF'], '/')) . '/uploads/results_qr/' . $folderName . '/' . $filename;
